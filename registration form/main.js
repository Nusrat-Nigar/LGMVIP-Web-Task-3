...
function data(){
   ...
   if(element[8].checked){skills.innerHTML="SKILLS: ReactJS";}
   ...
   if(element[5].checked && element[8].checked){skills.innerHTML="SKILLS: HTML,ReactJS";}
    if(element[6].checked && element[7].checked){skills.innerHTML="SKILLS: CSS,JS";}
  if(element[6].checked && element[8].checked){skills.innerHTML="SKILLS: CSS,ReactJS";}
    if(element[5].checked && element[6].checked && element[7].checked){skills.innerHTML="SKILLS: HTML,CSS,JS";}
  if(element[6].checked && element[7].checked && element[8].checked){skills.innerHTML="SKILLS: CSS,JS,ReactJs";}
  if(element[5].checked && element[6].checked && element[7].checked && element[8].checked){skills.innerHTML="SKILLS: HTML,CSS,JS,ReactJs";}
